    ...
    return (
        ...
        >
            ...
            >
                ...
                <Avatar src="" alt="" sx={{width:_300?60:40,height:60}}/>
            </Stack>
            <Typography variant="subtitle2">This is the bio!</Typography>
            <Stack
            flexDirection={'row'}
            justifyContent={'space-between'}
            alignItems={'center'}
        ...
        <Button size="large" sx={{color:'black',width:_700?"800px":"90%",mx:'auto',textAlign:'center',border:'1px solid gray',borderRadius:'10px',":hover":{
            cursor:'pointer'
        }}}>
        Edit Profile
        </Button>
